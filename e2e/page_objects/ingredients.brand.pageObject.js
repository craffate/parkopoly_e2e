module.exports = function() {
  ...
  this.logoSearchbarDropdown = this.logoSearchbar.element(by.repeater('object in brandFormCtrl.all.logos'));
  ...
  this.penaltySearchbarDropdown = this.penaltySearchbar.element(by.repeater('object in brandFormCtrl.all.penalties'));
