...
module.exports = function() {
  ...
  this.statusDropdown = element.all(by.repeater('status in $select.items'));
  this.badge = element(by.id('badges'));
  this.badgeInput = this.badge.$('input');
  this.badgeDropdown = element.all(by.repeater('item in $select.items'));
  ...
  this.occupationDropdown = element.all(by.repeater('p in $select.items'));
